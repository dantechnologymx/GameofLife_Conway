...
class GameOfLife
  ...
  if ARGV.count == 3
    ...
    puts 'You do not provide parameters. '
    puts 'Do you want to start the game by default? [Y/N]'
    answer = gets.chomp
  end

  unless answer.include?('Y') || answer.include? == ('N')
